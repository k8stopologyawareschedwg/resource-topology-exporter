...
func FromFlags(pArgs *ProgArgs, args ...string) (string, string, error) {
	...
	CommandLine.StringVar(&pArgs.Resourcemonitor.NUMAPlacement, "numa-placement", pArgs.Resourcemonitor.NUMAPlacement, fmt.Sprintf("Select the NUMA placement reporting mode. Use %q to enable container-level NUMA placement in NRT attributes. Use empty string to disable.", resourcemonitor.NUMAPlacementModeContainer))
